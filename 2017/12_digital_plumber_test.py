...
module = importlib.import_module("12_digital_plumber")

parse_pipes = module.parse_pipes
count_programs_with_access_to = module.count_programs_with_access_to
find_number_of_groups = module.find_number_of_groups
