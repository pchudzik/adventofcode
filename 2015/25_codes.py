...
def diagonal_resolver(column, row):
    index = 1
    r = 1
    c = 1
...
def get_code(column, row):
    index = diagonal_resolver(column, row)
    return reduce(
        lambda result, _: next_number(result),
        range(index - 1),
        20151125)
...
if __name__ == "__main__":
    column = 3019
    row = 3010
    print("code is", str(get_code(column, row)))
