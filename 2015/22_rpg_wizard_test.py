...
rpg_wizard_module = importlib.import_module("22_rpg_wizard")

Enemy = rpg_wizard_module.Enemy
Player = rpg_wizard_module.Player
MagicMissileSpell = rpg_wizard_module.MagicMissileSpell
DrainSpell = rpg_wizard_module.DrainSpell
ShieldSpell = rpg_wizard_module.ShieldSpell
PoisonSpell = rpg_wizard_module.PoisonSpell
RechargeSpell = rpg_wizard_module.RechargeSpell
SpellBook = rpg_wizard_module.SpellBook
encounter = rpg_wizard_module.encounter
