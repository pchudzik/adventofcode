...
next_password = importlib \
    .import_module("11_password_generator") \
    .next_password
has_increasing_straight_of_three_letters = importlib \
    .import_module("11_password_generator") \
    .has_increasing_straight_of_three_letters
has_no_forbidden_letters = importlib \
    .import_module("11_password_generator") \
    .has_no_forbidden_letters
has_at_least_two_different_non_overlapping_pairs_of_letters = importlib \
    .import_module("11_password_generator") \
