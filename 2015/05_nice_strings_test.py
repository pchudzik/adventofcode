...
is_nice_string = importlib\
    .import_module('05_nice_strings')\
    .is_nice_string

is_nice_string_improved = importlib\
    .import_module('05_nice_strings')\
    .is_nice_string_improved

count_nice_strings = importlib\
    .import_module('05_nice_strings')\
    .count_nice_strings

has_pair_of_dupplicated_letters = importlib\
    .import_module('05_nice_strings')\
    .has_pair_of_dupplicated_letters

has_repeating_letter_with_one_in_between = importlib\
    .import_module('05_nice_strings')\
