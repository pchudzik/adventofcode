...
room_parser = importlib.import_module("04_code").room_parser
count_sectors_of_real_rooms = importlib.import_module("04_code").count_sectors_of_real_rooms
Room = importlib.import_module("04_code").Room
